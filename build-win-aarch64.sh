...
tools/rcedit-x64 native-win-aarch64/Harmony.exe \
  --application-manifest packr/app.manifest \
  --set-icon app.ico

echo Harmony.exe aarch64 sha256sum
sha256sum native-win-aarch64/Harmony.exe

dumpbin //HEADERS native-win-aarch64/Harmony.exe
